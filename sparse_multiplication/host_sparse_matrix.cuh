#ifndef HOST_SPARSE_MATRIX_CUH
#define HOST_SPARSE_MATRIX_CUH
...
class DeviceCSRMatrix
{
  public:
    ...
    DeviceCSRMatrix& operator=(const DeviceCSRMatrix& other)
    {
      if (&other == this)
      {
        return *this;
    ...
    DeviceCSRMatrix& operator=(const HostCSRMatrix& other)
    {
      this->m_is_open = other.m_is_open;
      this->m_num_rows = other.m_num_rows;
      this->m_num_cols = other.m_num_cols;
